            ...
            for row in rows:
                ...
                if not qs:
                    ...
                    if len(qs) == 1:
                        ...
                        zkbs_cell_line.risk_potential = row[2].value if row[2].value else ""
                        zkbs_cell_line.origin = row[4].value if row[4].value else ""
                        zkbs_cell_line.virus = row[5].value if row[5].value else ""
                        zkbs_cell_line.genetically_modified = True if row[6].value == 'Ja' else False
                        zkbs_cell_line.save()
            ...
            for row in rows:
                ...
                if not qs:
                    ...
                    if len(qs) == 1:
                        ...
                        zkbs_oncogene.risk_potential = row[4].value if row[4].value else ""
                        zkbs_oncogene.reference = row[5].value if row[5].value else ""
                        zkbs_oncogene.additional_measures = True if row[6].value == 'Ja' else False
                        zkbs_oncogene.save()
