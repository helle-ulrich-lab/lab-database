...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('collection', '0023_auto_20180705_1458'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mammalian_line', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='collection.MammalianLine')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mammalian_line', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='collection.MammalianLine')),
            ],
            options={
