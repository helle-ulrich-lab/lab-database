...
class ScPombeStrain(models.Model, SaveWithoutHistoricalRecord):
    ...
    integrated_plasmids = models.ManyToManyField(
        "Plasmid", related_name="pombe_integrated_plasmids", blank=True
    )
    cassette_plasmids = models.ManyToManyField(
        "Plasmid",
        related_name="pombe_cassette_plasmids",
        help_text="Tagging and knock out plasmids",
        blank=True,
    )
    episomal_plasmids = models.ManyToManyField(
        "Plasmid",
        related_name="pombe_episomal_plasmids",
        blank=True,
    ...
    approval_user = models.ForeignKey(
        User, related_name="pombe_approval_user", on_delete=models.PROTECT, null=True
    )
    created_by = models.ForeignKey(
        User, related_name="pombe_createdby_user", on_delete=models.PROTECT
    )
    ...
    formz_projects = models.ManyToManyField(
        ...
        related_name="pombe_formz_project",
        blank=False,
    )
    ...
    formz_gentech_methods = models.ManyToManyField(
        ...
        related_name="pombe_gentech_method",
        blank=True,
    ...
    formz_elements = models.ManyToManyField(
        ...
        related_name="pombe_formz_element",
...
class ScPombeStrainEpisomalPlasmid(models.Model):
    ...
    formz_projects = models.ManyToManyField(
        FormZProject, related_name="pombe_episomal_plasmid_projects", blank=True
    )
    ...
    def save(
        ...
        super(ScPombeStrainEpisomalPlasmid, self).save(
