...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('collection', '0020_auto_20180705_1425'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='document',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='collection.MammalianLineDoc', verbose_name='Document (max. 2 MB)'),
        ),
    ]
